...
namespace MvcCoreUtilidades.Services
{
    public class ServiceStorageBlobs
    {
        ...
        public async Task CreateContainerAsync(string containerName)
        {
            ...
            //EL TIPO DE ACCESO A LOS BLOBS DEL CONTAINER
        ...
        public async Task <List<BlobModel>> GetBlobsAsync(string containerName)
        {
            ...
            {
                //EN LA INFORMACION DE UN BLOBITEM NO VIENE LA URL SOLO EL NOMBRE
        ...
        {
            //NECEISTAMOS ELBLOB CONTAINER CLIENTE PARA ELIMINAR SU INTERIOR
            BlobContainerClient containerClient = this.client.GetBlobContainerClient(containerName);
            //ELIMINAMOS DEL CONTENEDOR EL BLOB
            await containerClient.DeleteBlobAsync(blobName);
        }

        //METODO PARA SUBIR BLOBS
