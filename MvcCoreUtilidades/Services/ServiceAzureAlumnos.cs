...
namespace MvcCoreUtilidades.Services
{
    ...
    {
        //NO LO VAMOS A CREAR EN EL CONSTRUCTOR PORQUE NECESITAMOS EL TOKEN PARA ACCEDER
        ...
        public async Task<string> GetTokenAsync(string curso)
        {
            ...
            using (WebClient client = new WebClient())
            {
                ...
                string contenido = await client.DownloadStringTaskAsync(uri);
        ...
        //TENDREMOS UN METODO QUE LEERA EL SERVICIO AZURE STORAGE Y DEVOLVERA LOS ALUMNOS
        ...
        public async Task DeleteAlumnoAsync(string token, string partitionkey, string rowkey)
        {
